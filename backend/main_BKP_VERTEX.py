                ...
                for uni_data in unidades:
                    ...
                    for cfg in valid_confs:
                        ...
                        if abs(despesa_dre_mes_imp) > 0.01:
                            ...
                            inject_virtual_entry(c_cred, abs(despesa_dre_mes_imp), nat_c, f"Passivo/DARF Exigível - {desc} Unid {uni_nome}", logica=logica_dre, saldo_ant=0)
...
async def post_vendas(request: Request):
    ...
    try:
        ...
        # 1.5. Inserir Multiplas Unidades na VENDAUNIDADE
