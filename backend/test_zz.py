...
try:
    ...
    res = cur.fetchall()
    open('c:/Users/dirfe/.gemini/antigravity/scratch/vulcano2.0/backend/test_zz_out.txt', 'w', encoding='utf-8').write('LCTOs ZZ: ' + str(res))
    ...
    res2 = cur.fetchall()
    open('c:/Users/dirfe/.gemini/antigravity/scratch/vulcano2.0/backend/test_zz_out.txt', 'a', encoding='utf-8').write('\nOutros encerramentos: ' + str(res2))
