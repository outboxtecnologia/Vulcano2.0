...
try:
    ...
    res = cur.fetchall()
    open('c:/Users/dirfe/.gemini/antigravity/scratch/questor_explorer/backend/test_close_out.txt', 'w', encoding='utf-8').write('LCTOs 31/12: ' + str(res))
except Exception as e:
    open('c:/Users/dirfe/.gemini/antigravity/scratch/questor_explorer/backend/test_close_out.txt', 'w', encoding='utf-8').write(str(e))
