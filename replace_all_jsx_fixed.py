...
for file_path in jsx_files:
    ...
    # Rounded replacements (Safe non-greedy avoiding missing brackets)
    text = re.sub(r'rounded-(sm|md|lg|xl|2xl|full|\[[0-9]+.*?\])', 'rounded-[var(--v-radius)]', text)

    # Note: I omitted importing ThemeSwitcher since ThemeSwitcher is generic. But I need to apply fix_app_theme.py logic again on App.jsx since we reset it.
...
print("All JSX files safely refactored.")
