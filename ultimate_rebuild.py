...
print("Extracting variables from patching scripts...")
...
with open('conciliador_full.txt', 'r', encoding='utf-8') as f:
    all_extracted['conciliador_full'] = f.read()

print("Rebuilding VulcanoViews.jsx...")
...
vulcano_content = (
    vulcano_header + "\n\n" +
    all_extracted['new_receitas'] + "\n\n" +
    all_extracted['new_vendas_view'] + "\n\n" +
    all_extracted['new_recebimentos_view'] + "\n\n" +
    all_extracted['conciliador_full']
)

with open('frontend/src/VulcanoViews.jsx', 'w', encoding='utf-8') as f:
    f.write(vulcano_content)
print("VulcanoViews.jsx written!")

print("Rebuilding App.jsx...")
...
app_content = (
    ...
    "  if (!empresaConfirmed) {\n" +
    all_extracted['new_empresa_block'] +
    "\n  }\n\n" +
    all_extracted['new_shell'] + "\n" +
    """
            {/* MAIN CONTENT AREA */}
