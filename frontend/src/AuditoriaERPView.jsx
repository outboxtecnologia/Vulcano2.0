           ...
           <div className="flex items-center justify-between px-6 py-4 border-b border-[rgb(var(--v-accent-rgb)_/_0.2)] bg-[rgb(var(--v-accent-rgb)_/_0.05)] shrink-0">
             ...
             <div className="flex items-center gap-3">
               ...
               <div>
                 ...
                 <p className="text-xs font-black uppercase tracking-widest text-[var(--v-accent)]">Auditoria Autônoma — Cortex Agent (ReAct + HITL)</p>
              ...
              >
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--v-border)]">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-[var(--v-accent-5)] mb-0.5">Racional de Cálculo — Vulcano Motor Societário</p>
      ...
      <div className="flex items-center justify-between px-5 py-3.5 border-b border-[var(--v-ok)]/15 bg-[var(--v-ok)]/5">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-black uppercase tracking-widest text-[var(--v-accent-3)]">Conciliação Cross-Account — Órfãos</p>
          ...
          <div className="flex items-center justify-between p-4 border-b border-[var(--v-src-vu1)]/20 bg-[var(--v-src-vu1)]/5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-black uppercase tracking-widest text-[var(--v-accent-5)]">Diagnóstico IA — Causa Raiz Questor ↔ Vulcano</p>
                          ...
                          <td className="p-2">
                            ...
                            {c.level_shift ? (
                              ...
                              <div>
                                ...
                                <span className="text-[var(--v-accent-6)] font-black text-xs">⬆ {c.level_shift.competencia}</span>
