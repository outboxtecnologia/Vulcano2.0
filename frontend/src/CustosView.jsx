                ...
                <div className="flex-1">
                    ...
                    <div className="relative">
                        <select 
                            ...
                            className="w-full bg-[#151515] border border-[var(--v-border)] text-[var(--v-text-bold)] p-3 rounded-[var(--v-radius)] appearance-none focus:outline-none focus:border-[var(--v-accent-2)] flex items-center pr-10 hover:bg-[var(--v-hover)] transition-colors"
                        >
                                ...
                                <div className="magma-card flex-1 flex flex-col border border-[var(--v-border)] rounded-[var(--v-radius)] overflow-hidden min-h-[250px] shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                                     <div className="p-3 border-b border-[var(--v-border)] bg-[var(--v-deep)] flex justify-between items-center shrink-0">
                                        <h3 className="text-[10px] font-bold uppercase tracking-widest text-[#999] flex flex-col">
                                            ...
                                            <span className="text-[8px] text-[var(--v-text-faint)] opacity-80 mt-0.5">Composição Mensal de Desembolso Direto da Obra</span>
                                        </h3>
                                    </div>
                                        ...
                                        <table className="w-full text-left text-[11px] whitespace-nowrap">
                                              <thead className="bg-[#0b0b0b] sticky top-0 z-10 shadow-sm">
                                                  <tr>
                                                      ...
                                                      <th className="p-3 text-[var(--v-text-faint)] tracking-widest font-bold border-b border-[var(--v-border)]">Custo Acumulado R$</th>
                                                  </tr>
                                              </thead>
                                              <tbody>
                                                  {(!detalhamento.extrato_gerencial || detalhamento.extrato_gerencial.length === 0) ? (
                                                       <tr><td colSpan={2} className="p-6 text-center text-[var(--v-text-faint)] text-[10px] italic">Sem histórico de custos.</td></tr>
                                                  ) : (
                                                       detalhamento.extrato_gerencial.map((g, idx) => (
                                                            <tr key={idx} className="border-b border-[var(--v-bg)] hover:bg-[var(--v-hover)]">
                                                                ...
                                                                <td className="p-3 font-bold text-[var(--v-text-bold)] font-mono">{formatCurrency(g.valor)}</td>
                                                            </tr>
                                                       ))
                                                  )}
                                              </tbody>
                                        ...
                                        <table className="w-full text-left text-[10px] whitespace-nowrap">
                                              <thead className="bg-[#0b0b0b] sticky top-0 z-10 shadow-sm">
                                                  <tr>
                                                      ...
                                                      <th className="p-2 text-[var(--v-text-faint)] border-b border-[var(--v-border)]">Valor Apropriado</th>
                                                  </tr>
                                              </thead>
