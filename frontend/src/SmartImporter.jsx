          ...
          <div className="flex justify-between items-center bg-[var(--v-card)] p-4 border border-[var(--v-border)] rounded-[var(--v-radius)]">
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                disabled={loading}
                className="bg-[#34c759] text-black px-8 py-3 rounded-[var(--v-radius)] font-bold uppercase tracking-widest text-[10px] hover:opacity-80 transition-opacity disabled:opacity-50 flex items-center gap-2"
              >
