    ...
    for file in files:
        ...
        try:
            ...
            with open(filepath, 'r', encoding='utf-8', errors='ignore') as f:
                ...
                # App.jsx specific identifying strings
                if 'currentView ===' in content and 'BrowserRouter' in content and 'get_receitas_caixa' not in content:
                    app_candidates.append((filepath, stat.st_mtime, len(content)))
                
                # VulcanoViews.jsx specific identifying strings
                if 'export const RecebimentosView' in content and 'Stitch' not in content:
